...
export const projectsFr: Project[] = [
  {
    ...
    type: "fullstack",
    technologies: {
      backend: ["NextJS", "TypeScript", "tailwindcss"],
      database: ["PostgreSQL"],
      other: ["Railway", "JWT", "WebSockets"],
    },
    deployment: {
      platform: "Railway",
      url: "https://belidjo-frontend.vercel.app",
    },
    features: [
...

  {
    ...
    deployment: {
      platform: "GitHub",
      url: "https://github.com/Kouamekobenan/Belidjo.git",
    },
    features: [
  ...
  },
  {
    ...
    deployment: {
      platform: "GitHub",
      url: "https://github.com/Kouamekobenan/api-boisson.git",
    },
    features: [
  ...
  },
  {
    ...
    deployment: {
      platform: "GitHub",
      url: "https://github.com/Kouamekobenan/depot-website.git",
    },
    features: [
